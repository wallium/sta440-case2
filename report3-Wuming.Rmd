...
legend("topright", c("Female", "Male"), lty=c(1,1), lwd=c(2.5,2.5),col=c("blue", "red"))
...
plot(1:length(hazard.0), hazard.0, type='l', ylim=range(c(0,1)), col = c('blue'),
     ...
     lwd=2)
lines(1:length(hazard.1), hazard.1, type='l', col = c('red'), lwd=2)
legend("topright", c("Non-black", "Black"), lty=c(1,1), lwd=c(2.5,2.5),col=c("blue", "red"))
...
plot(1:length(hazard.0), hazard.0, type='l', ylim=range(c(0,1)), col = c('blue'),
     ...
     lwd=2)
lines(1:length(hazard.1), hazard.1, type='l', col = c('red'), lwd=2)
legend("topright", c("Non-hispanic", "Hispanic"), lty=c(1,1), lwd=c(2.5,2.5),col=c("blue", "red"))
...
legend("topright", c("0 symptom", "1 symptom", "2 symptoms", "3 symptoms", "4 symptoms"), lty=c(1,1), lwd=c(2.5,2.5),col=c("blue", "orange", "red", "green", "yellow"))
