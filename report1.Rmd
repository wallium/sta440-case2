...
```
To further explore the possible correlation between the nctdel time and number of symtons, we plot a smooth fitted line of nctdel time vs symptom. We can observe that the nctdel time is likely to be shorter for patients with more symptoms.
