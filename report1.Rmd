...
William plotted and analyzed histograms of each level of each indicator as part of the EDA and helped write potential modeling approaches. Wuming plotted the correlation between assessment time and number of symptoms curve and the Kaplan-Meier curve and helped write up some discussion about the Kaplan-Meier curve. Annie wrote the Goals and Data Description section and contributed the section on the Mann-Whitney-Wilcoxon test, and helped with the Modeling Approaches section. 